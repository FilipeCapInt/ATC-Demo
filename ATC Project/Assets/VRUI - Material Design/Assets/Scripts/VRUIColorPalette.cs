...
namespace SpaceBear.VRUI
{
	...
	public class VRUIColorPalette : MonoBehaviour
	{
		...
		private Color customColorDark = new Color(0.3396226f, 0.3396226f, 0.3396226f, 1f);
		private Color customColorLight = new Color(0.945098f, 0.945098f, 0.945098f, 1f);
		...
		public void UpdateColors()
		{
			...
			GameObject[] custom = GameObject.FindGameObjectsWithTag("VRUICustom");

			foreach (GameObject bg in custom)
			{
				Color color = isDarkTheme ? customColorDark : customColorLight;
